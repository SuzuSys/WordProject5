...
`;
export const createSchemaTest2 = /* GraphQL */ `
  mutation CreateSchemaTest2(
    $input: CreateSchemaTest2Input!
    $condition: ModelSchemaTest2ConditionInput
  ) {
    createSchemaTest2(input: $input, condition: $condition) {
      id
      name
      createdAt
      updatedAt
...
`;
export const updateSchemaTest2 = /* GraphQL */ `
  mutation UpdateSchemaTest2(
    $input: UpdateSchemaTest2Input!
    $condition: ModelSchemaTest2ConditionInput
  ) {
    updateSchemaTest2(input: $input, condition: $condition) {
      id
      name
      createdAt
      updatedAt
...
`;
export const deleteSchemaTest2 = /* GraphQL */ `
  mutation DeleteSchemaTest2(
    $input: DeleteSchemaTest2Input!
    $condition: ModelSchemaTest2ConditionInput
  ) {
    deleteSchemaTest2(input: $input, condition: $condition) {
      id
      name
      createdAt
      updatedAt
